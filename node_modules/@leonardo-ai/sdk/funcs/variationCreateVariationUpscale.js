...
exports.variationCreateVariationUpscale = void 0;
 ...
 */
async function variationCreateVariationUpscale(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreateVariationUpscaleRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/variations/upscale")();
    ...
    const [result] = await M.match(M.json(200, operations.CreateVariationUpscaleResponse$inboundSchema, {
        key: "object",
...
exports.variationCreateVariationUpscale = variationCreateVariationUpscale;
//# sourceMappingURL=variationCreateVariationUpscale.js.map