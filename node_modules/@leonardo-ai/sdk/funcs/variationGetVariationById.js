...
exports.variationGetVariationById = void 0;
 ...
 */
async function variationGetVariationById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetVariationByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/variations/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.GetVariationByIdResponse$inboundSchema, {
        key: "object",
...
exports.variationGetVariationById = variationGetVariationById;
//# sourceMappingURL=variationGetVariationById.js.map