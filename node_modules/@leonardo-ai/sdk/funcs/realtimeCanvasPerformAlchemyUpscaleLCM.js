...
exports.realtimeCanvasPerformAlchemyUpscaleLCM = void 0;
 ...
 */
async function realtimeCanvasPerformAlchemyUpscaleLCM(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.PerformAlchemyUpscaleLCMRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/lcm-upscale")();
    ...
    const [result] = await M.match(M.json(200, operations.PerformAlchemyUpscaleLCMResponse$inboundSchema, {
        key: "object",
...
exports.realtimeCanvasPerformAlchemyUpscaleLCM = realtimeCanvasPerformAlchemyUpscaleLCM;
//# sourceMappingURL=realtimeCanvasPerformAlchemyUpscaleLCM.js.map