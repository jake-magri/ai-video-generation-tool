...
exports.threeDModelAssetsDelete3DModelById = void 0;
 ...
 */
async function threeDModelAssetsDelete3DModelById(client, id, requestBody, options) {
    var _a;
    const input = {
        id: id,
        requestBody: requestBody,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.Delete3DModelByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/models-3d/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.Delete3DModelByIdResponse$inboundSchema, {
        key: "object",
...
exports.threeDModelAssetsDelete3DModelById = threeDModelAssetsDelete3DModelById;
//# sourceMappingURL=threeDModelAssetsDelete3DModelById.js.map