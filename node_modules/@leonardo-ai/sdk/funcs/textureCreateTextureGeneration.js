...
exports.textureCreateTextureGeneration = void 0;
 ...
 */
async function textureCreateTextureGeneration(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreateTextureGenerationRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/generations-texture")();
    ...
    const [result] = await M.match(M.json(200, operations.CreateTextureGenerationResponse$inboundSchema, {
        key: "object",
...
exports.textureCreateTextureGeneration = textureCreateTextureGeneration;
//# sourceMappingURL=textureCreateTextureGeneration.js.map