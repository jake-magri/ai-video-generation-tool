...
exports.elementsGetElementById = void 0;
 ...
 */
async function elementsGetElementById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetElementByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const [result] = await M.match(M.json(200, operations.GetElementByIdResponse$inboundSchema, {
        key: "object",
...
exports.elementsGetElementById = elementsGetElementById;
//# sourceMappingURL=elementsGetElementById.js.map