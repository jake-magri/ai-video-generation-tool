...
exports.imageDeleteGenerationById = void 0;
 ...
 */
async function imageDeleteGenerationById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteGenerationByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/generations/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteGenerationByIdResponse$inboundSchema, {
        key: "object",
...
exports.imageDeleteGenerationById = imageDeleteGenerationById;
//# sourceMappingURL=imageDeleteGenerationById.js.map