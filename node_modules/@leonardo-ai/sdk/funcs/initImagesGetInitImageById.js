...
exports.initImagesGetInitImageById = void 0;
 ...
 */
async function initImagesGetInitImageById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetInitImageByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const [result] = await M.match(M.json(200, operations.GetInitImageByIdResponse$inboundSchema, {
        key: "object",
...
exports.initImagesGetInitImageById = initImagesGetInitImageById;
//# sourceMappingURL=initImagesGetInitImageById.js.map