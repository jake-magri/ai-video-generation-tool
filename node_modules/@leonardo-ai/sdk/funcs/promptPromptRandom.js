...
exports.promptPromptRandom = void 0;
 ...
 */
async function promptPromptRandom(client, options) {
    var _a;
    const path = (0, url_js_1.pathToFunc)("/prompt/random")();
    ...
    const [result] = await M.match(M.json(200, operations.PromptRandomResponse$inboundSchema, {
        key: "object",
...
exports.promptPromptRandom = promptPromptRandom;
//# sourceMappingURL=promptPromptRandom.js.map