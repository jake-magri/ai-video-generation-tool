...
exports.textureDeleteTextureGenerationById = void 0;
 ...
 */
async function textureDeleteTextureGenerationById(client, id, requestBody, options) {
    var _a;
    const input = {
        id: id,
        requestBody: requestBody,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteTextureGenerationByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/generations-texture/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteTextureGenerationByIdResponse$inboundSchema, {
        key: "object",
...
exports.textureDeleteTextureGenerationById = textureDeleteTextureGenerationById;
//# sourceMappingURL=textureDeleteTextureGenerationById.js.map