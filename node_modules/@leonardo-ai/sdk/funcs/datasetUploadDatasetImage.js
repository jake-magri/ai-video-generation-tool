...
exports.datasetUploadDatasetImage = void 0;
 ...
 */
async function datasetUploadDatasetImage(client, requestBody, datasetId, options) {
    var _a;
    const input = {
        requestBody: requestBody,
        datasetId: datasetId,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.UploadDatasetImageRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/datasets/{datasetId}/upload")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.UploadDatasetImageResponse$inboundSchema, {
        key: "object",
...
exports.datasetUploadDatasetImage = datasetUploadDatasetImage;
//# sourceMappingURL=datasetUploadDatasetImage.js.map