...
exports.variationCreateVariationUnzoom = void 0;
 ...
 */
async function variationCreateVariationUnzoom(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreateVariationUnzoomRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/variations/unzoom")();
    ...
    const [result] = await M.match(M.json(200, operations.CreateVariationUnzoomResponse$inboundSchema, {
        key: "object",
...
exports.variationCreateVariationUnzoom = variationCreateVariationUnzoom;
//# sourceMappingURL=variationCreateVariationUnzoom.js.map