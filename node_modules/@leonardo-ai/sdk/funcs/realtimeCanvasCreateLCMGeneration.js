...
exports.realtimeCanvasCreateLCMGeneration = void 0;
 ...
 */
async function realtimeCanvasCreateLCMGeneration(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreateLCMGenerationRequestBody$outboundSchema.optional().parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/generations-lcm")();
    ...
    const [result] = await M.match(M.json(200, operations.CreateLCMGenerationResponse$inboundSchema, {
        key: "object",
...
exports.realtimeCanvasCreateLCMGeneration = realtimeCanvasCreateLCMGeneration;
//# sourceMappingURL=realtimeCanvasCreateLCMGeneration.js.map