...
exports.datasetGetDatasetById = void 0;
 ...
 */
async function datasetGetDatasetById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetDatasetByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const [result] = await M.match(M.json(200, operations.GetDatasetByIdResponse$inboundSchema, {
        key: "object",
...
exports.datasetGetDatasetById = datasetGetDatasetById;
//# sourceMappingURL=datasetGetDatasetById.js.map