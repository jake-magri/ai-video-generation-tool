...
exports.modelsGetModelById = void 0;
 ...
 */
async function modelsGetModelById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetModelByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const [result] = await M.match(M.json(200, operations.GetModelByIdResponse$inboundSchema, {
        key: "object",
...
exports.modelsGetModelById = modelsGetModelById;
//# sourceMappingURL=modelsGetModelById.js.map