...
exports.realtimeCanvasPerformInpaintingLCM = void 0;
 ...
 */
async function realtimeCanvasPerformInpaintingLCM(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.PerformInpaintingLCMRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/lcm-inpainting")();
    ...
    const [result] = await M.match(M.json(200, operations.PerformInpaintingLCMResponse$inboundSchema, {
        key: "object",
...
exports.realtimeCanvasPerformInpaintingLCM = realtimeCanvasPerformInpaintingLCM;
//# sourceMappingURL=realtimeCanvasPerformInpaintingLCM.js.map