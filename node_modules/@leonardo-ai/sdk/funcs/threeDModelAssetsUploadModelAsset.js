...
exports.threeDModelAssetsUploadModelAsset = void 0;
 ...
 */
async function threeDModelAssetsUploadModelAsset(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UploadModelAssetRequestBody$outboundSchema.optional().parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/models-3d/upload")();
    ...
    const [result] = await M.match(M.json(200, operations.UploadModelAssetResponse$inboundSchema, {
        key: "object",
...
exports.threeDModelAssetsUploadModelAsset = threeDModelAssetsUploadModelAsset;
//# sourceMappingURL=threeDModelAssetsUploadModelAsset.js.map