...
exports.realtimeCanvasPerformInstantRefine = void 0;
 ...
 */
async function realtimeCanvasPerformInstantRefine(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.PerformInstantRefineRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/lcm-instant-refine")();
    ...
    const [result] = await M.match(M.json(200, operations.PerformInstantRefineResponse$inboundSchema, {
        key: "object",
...
exports.realtimeCanvasPerformInstantRefine = realtimeCanvasPerformInstantRefine;
//# sourceMappingURL=realtimeCanvasPerformInstantRefine.js.map