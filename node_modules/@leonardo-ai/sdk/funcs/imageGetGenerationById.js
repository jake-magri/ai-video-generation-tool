...
exports.imageGetGenerationById = void 0;
 ...
 */
async function imageGetGenerationById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetGenerationByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const [result] = await M.match(M.json(200, operations.GetGenerationByIdResponse$inboundSchema, {
        key: "object",
...
exports.imageGetGenerationById = imageGetGenerationById;
//# sourceMappingURL=imageGetGenerationById.js.map