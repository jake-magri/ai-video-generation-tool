...
exports.initImagesUploadCanvasInitImage = void 0;
 ...
 */
async function initImagesUploadCanvasInitImage(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UploadCanvasInitImageRequestBody$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    const payload = parsed.value;
    const body = (0, encodings_js_1.encodeJSON)("body", payload, { explode: true });
    const path = (0, url_js_1.pathToFunc)("/canvas-init-image")();
    ...
    const [result] = await M.match(M.json(200, operations.UploadCanvasInitImageResponse$inboundSchema, {
        key: "object",
...
exports.initImagesUploadCanvasInitImage = initImagesUploadCanvasInitImage;
//# sourceMappingURL=initImagesUploadCanvasInitImage.js.map