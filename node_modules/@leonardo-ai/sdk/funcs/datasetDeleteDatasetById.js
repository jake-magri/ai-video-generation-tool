...
exports.datasetDeleteDatasetById = void 0;
 ...
 */
async function datasetDeleteDatasetById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteDatasetByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/datasets/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteDatasetByIdResponse$inboundSchema, {
        key: "object",
...
exports.datasetDeleteDatasetById = datasetDeleteDatasetById;
//# sourceMappingURL=datasetDeleteDatasetById.js.map