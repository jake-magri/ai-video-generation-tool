...
exports.elementsDeleteElementById = void 0;
 ...
 */
async function elementsDeleteElementById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteElementByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/elements/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteElementByIdResponse$inboundSchema, {
        key: "object",
...
exports.elementsDeleteElementById = elementsDeleteElementById;
//# sourceMappingURL=elementsDeleteElementById.js.map