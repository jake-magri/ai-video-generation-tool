...
exports.initImagesDeleteInitImageById = void 0;
 ...
 */
async function initImagesDeleteInitImageById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteInitImageByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/init-image/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteInitImageByIdResponse$inboundSchema, {
        key: "object",
...
exports.initImagesDeleteInitImageById = initImagesDeleteInitImageById;
//# sourceMappingURL=initImagesDeleteInitImageById.js.map