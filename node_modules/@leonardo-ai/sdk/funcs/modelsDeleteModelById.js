...
exports.modelsDeleteModelById = void 0;
 ...
 */
async function modelsDeleteModelById(client, id, options) {
    var _a;
    const input = {
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.DeleteModelByIdRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    ...
    const path = (0, url_js_1.pathToFunc)("/models/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations.DeleteModelByIdResponse$inboundSchema, {
        key: "object",
...
exports.modelsDeleteModelById = modelsDeleteModelById;
//# sourceMappingURL=modelsDeleteModelById.js.map