...
exports.variationCreateVariationNoBG = void 0;
 ...
 */
async function variationCreateVariationNoBG(client, request, options) {
    var _a;
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreateVariationNoBGRequestBody$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    const payload = parsed.value;
    const body = (0, encodings_js_1.encodeJSON)("body", payload, { explode: true });
    const path = (0, url_js_1.pathToFunc)("/variations/nobg")();
    ...
    const [result] = await M.match(M.json(200, operations.CreateVariationNoBGResponse$inboundSchema, {
        key: "object",
...
exports.variationCreateVariationNoBG = variationCreateVariationNoBG;
//# sourceMappingURL=variationCreateVariationNoBG.js.map